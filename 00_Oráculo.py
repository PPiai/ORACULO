...
def pagina_chat():
    ...
    if chain is None:
        ...
        st.markdown(f'<h7 style="text-align: center;">🤖Para não ocorrer erros, envie uma mensagem como "olá" para inicializar a memória do chat</h7>', unsafe_allow_html=True)
        st.stop()
